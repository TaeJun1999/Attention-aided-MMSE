...
## Experimental Results on 3GPP TDL Channels

The following figures show the NMSE performance of **A-MMSE** across five 3GPP TDL (Tapped Delay Line) channel models (TDL-A through TDL-E), evaluated over a wide range of SNR conditions.
...
| Channel | Figure |
|---------|--------|
| TDL-A | [TDLA_SNR.pdf](figures/TDLA_SNR.pdf) |
| TDL-B | [TDLB_SNR.pdf](figures/TDLB_SNR.pdf) |
| TDL-C | [TDLC_SNR.pdf](figures/TDLC_SNR.pdf) |
| TDL-D | [TDLD_SNR.pdf](figures/TDLD_SNR.pdf) |
| TDL-E | [TDLE_SNR.pdf](figures/TDLE_SNR.pdf) |

> All figures are stored in the [`figures/`](figures/) directory.
